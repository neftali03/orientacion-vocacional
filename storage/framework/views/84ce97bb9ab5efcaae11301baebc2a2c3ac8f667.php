        ...
        <div class="container text-center py-5">
            <div class="row align-items-start">
                <div class="col-12 col-md-6 order-1 mt-5 py-5 d-flex justify-content-center">
                    <img src="<?php echo e(asset('LogoITCA.png')); ?>" style="height: 135px" alt="Imagen">
                </div>
                <div class="col-12 col-md-6 order-2 order-md-1">
                    ...
                    <a href="<?php echo e(route('test')); ?>" class="btn btn-orange btn-lg px-5 py-3 fw-bold">Iniciar</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/neftali/Source/orientacion-vocacional/resources/views/index.blade.php ENDPATH**/ ?>